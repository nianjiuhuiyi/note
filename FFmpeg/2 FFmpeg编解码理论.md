...
3. libacodec：编解码库，包含各种类型音频/视频的编解码器。封装了Codec层，但是有一些codec是具备自己的License的，ffmpeg不会默认添加像libx264、FDK-AAC、Lame等库，但是ffmpeg是一个平台，可以将其他的第三方codec以插件的方式编译添加进来，以供统一接口，
